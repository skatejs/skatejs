...
*/
  ...
  (function() {
    ...
    function Ud(a) {
      ...
      if (Qa && Qa.get) b(Element.prototype, Qa);
      else if (Ra && Ra.get) b(HTMLElement.prototype, Ra);
      else {
      ...
      Yb
        ? c(HTMLElement.prototype, Yb)
        : Zb
          ? c(Element.prototype, Zb)
          : console.warn(
        ...
        x(c, 'replaceWith', function(c) {
          ...
          if (v)
            for (a.a(this), d = 0; d < e.length; d++)
              (k = e[d]), k instanceof Element && a.b(k);
        });
      void 0 !== b.remove &&
        x(c, 'remove', function() {
          var c = t(this);
        ...
        return function(c) {
          ...
          for (var f = [], g = 0; g < d.length; g++) {
            ...
            if (p instanceof DocumentFragment)
              for (p = p.firstChild; p; p = p.nextSibling) e.push(p);
            else e.push(p);
          }
          b.apply(this, d);
          for (d = 0; d < f.length; d++) a.a(f[d]);
    ...
    function he(a) {
      window.HTMLElement = (function() {
        function b() {
          ...
          if (0 === e.length)
            return (
              (e = Sa.call(document, d.localName)),
    ...
    function Xa(a, b) {
      ...
      'loading' === this.a.readyState &&
        ((this.P = new MutationObserver(this.f.bind(this))),
    ...
    function wa(a) {
      if (!a.__shady || void 0 === a.__shady.firstChild) {
        ...
        ec(a);
        for (
          var b = (a.__shady.childNodes = X(a)), c = 0, d;
          c < b.length && (d = b[c]);
          c++
        )
          (d.__shady = d.__shady || {}),
    ...
    function aa() {
      for (var a = 0; a < Z; a += 2)
        (0, Y[a])(Y[a + 1]), (Y[a] = void 0), (Y[a + 1] = void 0);
      Z = 0;
    }
    function qe() {
      try {
    ...
    function kc(a, b, c) {
      ...
      c === cb &&
      b.constructor.resolve === eb
        ? te(a, b)
        : c === ka
          ? (C(a, ka.error), (ka.error = null))
          : void 0 === c
            ? L(a, b)
            : 'function' === typeof c ? se(a, b, c) : L(a, b);
    }
    function ja(a, b) {
      if (a === b)
    ...
    function fb(a) {
      var b = a.U,
        c = a.o;
      if (0 !== b.length) {
        for (var d, e, f = a.m, h = 0; h < b.length; h += 3)
          (d = b[h]), (e = b[h + c]), d ? ic(c, d, e, f) : e(f);
        a.U.length = 0;
      }
    }
    function lc() {
    ...
    function la(a, b) {
      ...
      this.L[ya] || hc(this.L);
      nc(b)
        ? ((this.aa = this.length = b.length),
          (this.m = Array(this.length)),
          0 === this.length
            ? L(this.L, this.m)
            : ((this.length = this.length || 0),
              this.eb(b),
              0 === this.aa && L(this.L, this.m)))
        : C(this.L, Error('Array Methods must be provided an Array'));
    }
    function D(a) {
      this[ya] = mc++;
      ...
      if (ba !== a) {
        ...
        if (this instanceof D) ve(this, a);
        else
          throw new TypeError(
        ...
        a: {
          ...
          switch (k.nodeType) {
            case Node.ELEMENT_NODE:
              for (
                var p = k.localName, l = '<' + p, r = k.attributes, n = 0;
                (v = r[n]);
                n++
              )
                l += ' ' + v.name + '="' + v.value.replace(ye, sc) + '"';
              l += '>';
              k = ze[p] ? l : l + mb(k, g) + '</' + p + '>';
              break a;
            case Node.TEXT_NODE:
    ...
    function pb(a, b, c) {
      ...
      if (c) {
        ...
        if ((void 0 !== d && d !== a) || (void 0 === d && da(c) !== a))
          throw Error(
      ...
      h ||
        ((h = J(a) ? a.host : a),
        c ? ((c = Gc(c)), sb.call(h, b, c)) : Hc.call(h, b));
      Ic(a, b);
      return b;
    }
    function qb(a, b) {
      ...
      f ||
        ((f = J(a) ? a.host : a),
        ((!a.__shady.root && 'slot' !== b.localName) || f === da(b)) &&
          oa.call(f, b));
      Ic(a, null, b);
      return b;
    }
    function Jc(a) {
      if (a.__shady && void 0 !== a.__shady.wa)
        for (
    ...
    function Gc(a) {
      ...
      a &&
        'slot' === a.localName &&
        (b =
          (b = a.__shady && a.__shady.W) && b.length
            ? b[0]
            : Gc(a.nextSibling));
      return b;
    }
    ...
    function Kc(a, b) {
      'slot' === b
        ? ((a = a.parentNode), rb(a) && a.__shady.root.O())
        : 'slot' === a.localName &&
          'name' === b &&
          (b = ma(a)) &&
          (b.jb(a), b.O());
    ...
    function Ic(a, b, c) {
      if ((a = a.__shady && a.__shady.Y))
        b && a.addedNodes.push(b), c && a.removedNodes.push(c), a.vb();
    }
    function Lc(a) {
      if (a && a.nodeType) {
        a.__shady = a.__shady || {};
        var b = a.__shady.wa;
        void 0 === b &&
          (J(a) ? (b = a) : (b = (b = a.parentNode) ? Lc(b) : a),
          pa.call(document.documentElement, a) && (a.__shady.wa = b));
        return b;
      }
    }
    function Aa(a, b, c) {
    ...
    function Oc(a, b, c) {
      ...
      Ba && 'class' === b
        ? Ba.setElementClass(a, c)
        : (Pc.call(a, b, c), Kc(a, b));
    }
    function Qc(a, b) {
    ...
    function Sc(a, b, c) {
      if ((c = b.__handlers && b.__handlers[a.type] && b.__handlers[a.type][c]))
        for (
          var d = 0, e;
          (e = c[d]) && a.target !== a.relatedTarget && (e.call(b, a), !a.Va);
          d++
        );
    }
    function Ce(a) {
      ...
      for (c = 0; c < b.length; c++) {
        ...
        if (0 === c || (f && f === e))
          if ((Sc(a, d, 'bubble'), d !== window && (e = d.getRootNode()), a.ma))
            break;
      }
    }
    ...
    function Uc(a, b, c) {
      if (b) {
        ...
        k = function(d) {
          ...
          if (d.composed || -1 < d.composedPath().indexOf(h))
        ...
        wb[a]
          ? ((this.__handlers = this.__handlers || {}),
            ...
            this.__handlers[a][d ? 'capture' : 'bubble'].push(k))
          : (this instanceof Window ? Wc : Xc).call(this, a, k, c);
      }
    }
    function Yc(a, b, c) {
      if (b) {
        ...
        g &&
          ((e = Tc(g, h, a, d, e, f)),
          -1 < e && ((k = g.splice(e, 1)[0].zb), g.length || (b[qa] = void 0)));
    ...
    function Ee(a, b, c, d) {
      ...
      for (m = 1; m < d; m++)
        for (p = 1; p < k; p++)
          if (a[g + p - 1] === c[h + m - 1]) b[m][p] = b[m - 1][p - 1];
          else {
            var l = b[m - 1][p] + 1,
              n = b[m][p - 1] + 1;
            b[m][p] = l < n ? l : n;
        ...
        0 == g
          ...
          : 0 == h
            ...
            : ((k = b[g - 1][h - 1]),
              (m = b[g - 1][h]),
              (p = b[g][h - 1]),
              (l = m < p ? (m < k ? m : k) : p < k ? p : k),
              l == k
                ? (k == d ? a.push(0) : (a.push(1), (d = k)), g--, h--)
                : l == m
                  ? (a.push(3), g--, (d = m))
                  : (a.push(2), h--, (d = p)));
      a.reverse();
    ...
    function Ge() {
      ...
      P(a.prototype, Ke);
      G.X &&
        (U(window.Node.prototype),
        U(window.Text.prototype),
        U(window.DocumentFragment.prototype),
        U(window.Element.prototype),
        U(a.prototype),
        U(window.Document.prototype),
        window.HTMLSlotElement && U(window.HTMLSlotElement.prototype));
    }
    function gd(a) {
      var b = Le.has(a);
        ...
        if (d.nodeType === Node.ELEMENT_NODE) {
          ...
          if ('link' === f && 'import' === e.getAttribute('rel')) {
            ...
            if (d instanceof Node && !c.has(d))
              for (c.add(d), d = d.firstChild; d; d = d.nextSibling) S(d, b, c);
            d = yb(a, e);
            continue;
          } else if ('template' === f) {
            d = yb(a, e);
          ...
          if ((e = e.__CE_shadowRoot))
            for (e = e.firstChild; e; e = e.nextSibling) S(e, b, c);
        }
    ...
    function zb(a) {
      ...
      for (var e = d, f = 0, h = c.length; f < h; f++)
        if ('{' === c[f]) {
          e.rules || (e.rules = []);
          var k = e,
            g = k.rules[k.rules.length - 1] || null;
          e = new Pa();
          e.start = f + 1;
          e.parent = k;
          e.previous = g;
      ...
      a.parent &&
        ...
        a.atRule
          ? 0 === c.indexOf('@media')
            ...
            : c.match(I.rb) &&
              ((a.type = M.ka),
              (a.keyframesName = a.selector.split(I.Ma).pop()))
          : (a.type = 0 === c.indexOf('--') ? M.xa : M.STYLE_RULE));
      if ((c = a.rules))
        for (var d = 0, e = c.length, f; d < e && (f = c[d]); d++) hd(f, b);
      return a;
    }
    function Me(a) {
      ...
      if (a.cssText || a.rules) {
        ...
        if (f) {
          ...
          b
            ? (b = a.cssText)
            : ((b = a.cssText),
              (b = b.replace(I.Ha, '').replace(I.La, '')),
              (b = b.replace(I.sb, '').replace(I.xb, ''))),
            (d = b.trim()) && (d = '  ' + d + '\n');
      }
      d &&
    ...
    function Ca(a) {
      !a.__cssRules && a.textContent && (a.__cssRules = zb(a.textContent));
    ...
    function ld(a, b, c) {
      ...
      V
        ? a.compareDocumentPosition(V) === Node.DOCUMENT_POSITION_PRECEDING &&
          (V = a)
        : (V = a);
    }
    function md(a, b) {
        ...
        if (c.target !== document.documentElement && c.target !== document.head)
          for (var d = 0; d < c.addedNodes.length; d++) {
            ...
            if (e.nodeType === Node.ELEMENT_NODE) {
              ...
              var k = [];
              h.classList
                ? (k = Array.from(h.classList))
                : h instanceof window.SVGElement &&
                  h.hasAttribute('class') &&
                  (k = h.getAttribute('class').split(/\s+/));
              h = k;
              k = h.indexOf(q.a);
              if ((h = -1 < k ? h[k + 1] : '') && f === e.ownerDocument)
                q.b(e, h, !0);
              else if (
      ...
      Object.assign ||
        (Object.assign = function(a, b) {
          for (var c = [].slice.call(arguments, 1), d = 0, e; d < c.length; d++)
            if ((e = c[d]))
              for (
                var f = a, g = e, l = Object.getOwnPropertyNames(g), n = 0;
                n < l.length;
                n++
              )
                (e = l[n]), (f[e] = g[e]);
    ...
    (function() {
      ...
      if (b) {
        var h = document.implementation.createHTMLDocument('template'),
          k = !0,
            ...
            Object.defineProperty(b, 'innerHTML', {
              get: function() {
                for (
                  ...
                  a += b.outerHTML || b.data.replace(t, u);
                return a;
              },
              set: function(b) {
                h.body.innerHTML = b;
                for (a.V(h); this.content.firstChild; )
                  this.content.removeChild(this.content.firstChild);
                for (; h.body.firstChild; )
                  this.content.appendChild(h.body.firstChild);
              },
              configurable: !0
            });
          },
              ...
              set: function(a) {
                if (this.parentNode) {
                  ...
                  for (
                    ...
                    a.appendChild(h.body.firstChild);
        ...
        (a.a = function(a, b) {
          ...
          (Node.prototype.cloneNode = function(b) {
            if (this instanceof DocumentFragment)
              if (b) var d = this.ownerDocument.importNode(this, !0);
    ...
    var nc = Db,
      ...
      ab,
      $a,
      qd = 'undefined' !== typeof window ? window : void 0,
      rd = qd || {},
      gc = rd.MutationObserver || rd.WebKitMutationObserver,
      Re =
    ...
    var le =
      ...
      '[object process]' === {}.toString.call(process)
        ...
        : gc
          ? oe()
          : Re ? pe() : qd || 'function' !== typeof require ? bb() : qe();
    var ya = Math.random()
        .toString(36)
        .substring(16),
      ka = new lc(),
        ...
        ? ((d = jc(a)),
          d === cb && void 0 !== a.o
            ...
            : 'function' !== typeof d
              ? (this.aa--, (this.m[b] = a))
              : c === D
                ? ((c = new c(ba)), kc(c, a, d), this.ra(c, b))
                : this.ra(
                    new c(function(b) {
                      return b(a);
                    }),
    ...
    window.Promise ||
      ((window.Promise = D), (D.prototype['catch'] = D.prototype.a));
    (function(a) {
      function b(a, b) {
        ...
        q = {
          ...
          ga: function(a, b) {
            ...
            c ||
              ...
              (q.$a = c),
              (c.za = c.createElement('base')),
              c.head.appendChild(c.za),
              (c.ya = c.createElement('a')));
            c.za.href = b;
            c.ya.href = a;
            return c.ya.href || a;
          }
      ...
      g.prototype.s = function(a, b) {
        ...
        if ((c = a.querySelector('base')))
          (b = q.ga(c.getAttribute('href'), b)), c.removeAttribute('href');
    ...
    var sd = document.querySelector('script[src*="webcomponents-lite.js"]'),
      Se = /wc-(.+)/,
      H = {};
    if (!H.noOpts) {
      location.search
      ...
      if (sd)
        for (var td = 0, Fa; (Fa = sd.attributes[td]); td++)
          'src' !== Fa.name && (H[Fa.name] = Fa.value || !0);
    ...
    var ud = H.shadydom;
    ud &&
      ((window.ShadyDOM = window.ShadyDOM || {}), (window.ShadyDOM.force = ud));
    ...
    G.Ka = G.force || !G.ob;
    var ha = Element.prototype,
      wd =
        ha.matches ||
        ha.matchesSelector ||
        ha.mozMatchesSelector ||
        ha.msMatchesSelector ||
        ha.oMatchesSelector ||
        ha.webkitMatchesSelector,
      kb = document.createTextNode(''),
      pc = 0,
      jb = [];
    ...
    var Hc = Element.prototype.appendChild,
      sb = Element.prototype.insertBefore,
      oa = Element.prototype.removeChild,
      Pc = Element.prototype.setAttribute,
      xd = Element.prototype.removeAttribute,
      Fb = Element.prototype.cloneNode,
      tb = Document.prototype.importNode,
      Xc = Element.prototype.addEventListener,
      ...
      pa = Node.prototype.contains || HTMLElement.prototype.contains,
      Ve = Object.freeze({
        appendChild: Hc,
        insertBefore: sb,
        removeChild: oa,
      ...
      nb = {
        ...
        innerHTML: {
          ...
          set: function(a) {
            ...
            for (
              Hb && Hb.set ? Hb.set.call(Ga, a) : (Ga.innerHTML = a);
              Ga.firstChild;

            )
              b.appendChild(Ga.firstChild);
          },
          configurable: !0
        }
      },
      ...
      ob = {
        activeElement: {
          get: function() {
            var a =
              Ib && Ib.get
                ? Ib.get.call(document)
                : G.X ? void 0 : document.activeElement;
            if (a && a.nodeType) {
              var b = !!J(this);
              if (
                this === document ||
                (b && this.host !== a && pa.call(this.host, a))
              ) {
      ...
      ad = {
        ...
        get relatedTarget() {
          ...
          return Rc(this.currentTarget, this.Ca);
        },
      ...
      wb = { focus: !0, blur: !0 },
      Ye = vb(window.Event),
      Ze = vb(window.CustomEvent),
      $e = vb(window.MouseEvent),
      dc = {};
    ...
    l.prototype.H = function(a, b) {
      ...
      a.__shady = a.__shady || {};
      a.__shady.root = this;
      a.__shady.tb = 'closed' !== this.J ? this : null;
      this.ba = !1;
      this.b = [];
      this.a = {};
      this.c = [];
    ...
    l.prototype.h = function(a, b) {
      ...
      c !== a.__shady.assignedSlot &&
        ...
        (a.__shady.assignedSlot.__shady.ta = !0);
    };
    ...
    l.prototype.v = function() {
      ...
      for (a = 0; a < b.length; a++)
        (c = b[a]), this.T(c === this ? this.host : c, this.B(c));
    };
    ...
    l.prototype.T = function(a, b) {
      for (
        var c = X(a), d = Ee(b, b.length, c, c.length), e = 0, f = 0, h;
        e < d.length && (h = d[e]);
        e++
      ) {
        for (var g = 0, l; g < h.Z.length && (l = h.Z[g]); g++)
          da(l) === a && oa.call(a, l), c.splice(h.index + f, 1);
        f -= h.ca;
      }
      for (e = 0; e < d.length && (h = d[e]); e++)
        for (f = c[h.index], g = h.index; g < h.index + h.ca; g++)
          (l = b[g]), sb.call(a, l, f), c.splice(g, 0, l);
    };
    ...
    var Ie = {
        addEventListener: Uc.bind(window),
        removeEventListener: Yc.bind(window)
      },
      He = {
        addEventListener: Uc,
        removeEventListener: Yc,
        ...
        cloneNode: function(a) {
          if ('template' == this.localName) var b = Fb.call(this, a);
          else if (((b = Fb.call(this, !1)), a)) {
            a = this.childNodes;
        ...
        get isConnected() {
          ...
          if (
            (Ue && pa.call(a, this)) ||
            (a.documentElement && pa.call(a.documentElement, this))
          )
            return !0;
    ...
    var af = HTMLElement.prototype.blur,
      Ke = ib({
        blur: function() {
    ...
    var Sa = window.Document.prototype.createElement,
      ee = window.Document.prototype.createElementNS,
      de = window.Document.prototype.importNode,
      fe = window.Document.prototype.prepend,
      ge = window.Document.prototype.append,
      bf = window.DocumentFragment.prototype.prepend,
      cf = window.DocumentFragment.prototype.append,
      Tb = window.Node.prototype.cloneNode,
      ua = window.Node.prototype.appendChild,
      $b = window.Node.prototype.insertBefore,
      Ta = window.Node.prototype.removeChild,
      ac = window.Node.prototype.replaceChild,
      ...
      Vd = window.Element.prototype.prepend,
      ...
      ae = window.Element.prototype.remove,
    ...
    if (
      !Ha ||
      Ha.forcePolyfill ||
      'function' != typeof Ha.define ||
      'function' != typeof Ha.get
    ) {
      var ia = new B();
      he(ia);
      ce(ia);
    ...
    var M = { STYLE_RULE: 1, ka: 7, MEDIA_RULE: 4, xa: 1e3 },
      I = {
        mb: /\/\*[^*]*\*+([^/*][^*]*\*+)*\//gim,
        port: /@import[^;]*;/gim,
        Ha: /(?:^[^;\-\s}]+)?--[^;{}]*?:[^{};]*?(?:[;\n]|$)/gim,
    ...
    if (window.ShadyCSS && void 0 !== window.ShadyCSS.nativeCss)
      ...
      window.ShadyCSS
        ? (jd(window.ShadyCSS), (window.ShadyCSS = void 0))
        : jd(window.WebComponents && window.WebComponents.flags);
    ...
    u.prototype.h = function(a, b, c) {
      if (b)
        if (a.classList)
          ...
          var d = a.getAttribute(hf);
          c
            ? d && ((b = d.replace('style-scope', '').replace(b, '')), Da(a, b))
            : Da(a, (d ? d + ' ' : '') + 'style-scope ' + b);
        }
    };
    ...
    u.prototype.g = function(a, b, c) {
      ...
      a = a.replace(lf, function(a, f, g) {
        e ||
          ((a = d.D(g, f, b, c)), (e = e || a.stop), (f = a.lb), (g = a.value));
        return f + g;
      });
      f && (a = this.v(a));
      return a;
    ...
    u.prototype.D = function(a, b, c, d) {
      ...
      0 <= a.indexOf(Kb)
        ? (a = this.H(a, d))
        : 0 !== e && (a = c ? this.u(a, c) : a);
      c = !1;
      0 <= e && ((b = ''), (c = !0));
      if (c) {
        var f = !0;
        c &&
          (a = a.replace(mf, function(a, b) {
            return ' > ' + b;
          }));
      }
    ...
    var Ed = (function(a) {
      ...
      qf = navigator.userAgent.match('Trident');
    ...
    n.prototype.f = function(a, b) {
      ...
      for (var c = 0, d, e; c < a.length; c++)
        if ((d = a[c])) {
          Ja.lastIndex = 0;
          if ((e = Ja.exec(d))) d = this.a(b[e[1]], b);
    ...
    n.prototype.B = function(a, b) {
      ...
      if (a.Ja)
        if (null == a.ea) {
          a.ea = [];
          for (var e in b)
            (d = b[e]), (d = d(c)), c !== d && ((c = d), a.ea.push(e));
        } else {
          for (e = 0; e < a.ea.length; ++e) (d = b[a.ea[e]]), (c = d(c));
          d = c;
        }
      a.cssText = d;
    };
    ...
    n.prototype.ja = function(a, b, c, d) {
      ...
      if (b.w.F) {
        ...
        var f = b.parsedSelector,
          g = ':host > *' === f || 'html' === f,
          k = 0 === f.indexOf(':host') && !g;
        'shady' === c &&
          ((g = f === e + ' > *.' + e || -1 !== f.indexOf('html')),
          (k = !g && 0 === f.indexOf(e)));
        'shadow' === c &&
          ((g = ':host > *' === f || 'html' === f), (k = k && !g));
        if (g || k)
          (c = e),
            k && (z && !b.A && (b.A = q.s(b, q.g, q.i(a), e)), (c = b.A || e)),
            d({ wb: c, qb: k, Hb: g });
      }
    };
    ...
    n.prototype.l = function(a, b, c, d) {
      ...
      d = '.' + d;
      for (
        var e = a.A.split(','), f = 0, g = e.length, k;
        f < g && (k = e[f]);
        f++
      )
        e[f] = k.match(b) ? k.replace(c, d) : d + ' ' + k;
      a.selector = e.join(',');
    };
    ...
    n.prototype.v = function(a, b, c, d) {
      ...
      z
        ? e.a
          ...
          : b && (d = Ab(b, c, a.shadowRoot, e.b))
        : d
          ? d.parentNode ||
            (qf && -1 < b.indexOf('@media') && (d.textContent = b),
            ld(d, null, e.b))
          : b && (d = Ab(b, c, null, e.b));
      d &&
    ...
    if (!z) {
      var Fd = new MutationObserver(nd),
        Gd = function(a) {
      ...
      if (
        ...
        window.HTMLImports
          ? window.HTMLImports.whenReady(Nb)
          : requestAnimationFrame(function() {
    ...
    var Ea = {},
      Qe = Promise.resolve(),
      Bb = null,
      pd = (window.HTMLImports && window.HTMLImports.whenReady) || null,
      Cb,
      La = null,
      sa = null;
    ...
    g.prototype.prepareTemplate = function(a, b, c) {
      if (!a.f) {
        ...
        A || (d = Q.J(a._styleAst));
        if (!d.length || A)
          (b = this.T(c, a._styleAst, z ? a.content : null, Mb[b])), (a.a = b);
        a.c = d;
      }
    };
    ...
    g.prototype.H = function() {
      !this.a &&
        ...
        ((this.a = window.ShadyCSS.ApplyShim), (this.a.invalidCallback = Oe));
    };
    g.prototype.I = function() {
      var a = this;
      !this.b &&
    ...
    g.prototype.f = function() {
      ...
      if (this.b) {
        ...
        this.b.enqueued &&
          (A ? this.Qa(a) : (this.u(this.g, this.h), this.D(a)),
          (this.b.enqueued = !1),
        ...
        if (((e = Ea[c]) || this.j(a)) && e && e.a && !od(e)) {
          if (
            ...
            this.c(),
              ...
              (e.a.textContent = q.c(a, d.G)),
              Pe(e);
          z &&
            (c = a.shadowRoot) &&
            (c.querySelector('style').textContent = q.c(a, d.G));
          d.G = e._styleAst;
        }
    ...
    var Ob = window.customElements,
      Ma = window.HTMLImports,
      Kd = window.HTMLTemplateElement;
