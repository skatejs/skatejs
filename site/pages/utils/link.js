    ...
    <Layout.is title="emit()">
      <Marked.is
        src={`
          ...
          For example, if I have an input element that I want to link back to some internal state, I can do so in a couple lines of code. Let's first build out our component, then we'll link it up.
