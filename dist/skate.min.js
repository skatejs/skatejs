...
b.inherit=function(a,b,c){for(var h=Object.getOwnPropertyNames(b),l=h.length,k=0;k<l;k++){var m=h[k];if(c||void 0===a[m]){var f=Object.getOwnPropertyDescriptor(b,m);!f.get&&!f.set&&f.writable&&f.enumerable&&f.configurable?a[m]=b[m]:Object.defineProperty(a,m,f)}}return a};b.objEach=function(a,b){for(var c in a)m(a,c)&&b(a[c],c)};"use strict";var c=a("./constants").ATTR_IGNORE},{"./constants":1}],10:[function(a,h,b){b["default"]="0.12.0"},{}]},{},[8]);
