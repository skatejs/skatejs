...
s.set(a,b);g();e.register(b.remove);!h&&x&&(h=m(b));return h}var e=a("./document-observer")["default"],d=a("./lifecycle").triggerCreated,p=a("./lifecycle").triggerAttached,q=a("./lifecycle").triggerDetached,l=a("./lifecycle").triggerAttributeChanged,k=a("./lifecycle").initElements,s=a("./registry")["default"];h=a("./utils").debounce;var f=a("./utils").inherit;a=a("./version")["default"];var g=h(function(){"complete"===document.readyState||"interactive"===document.readyState?k(document.documentElement.childNodes):
document.addEventListener("DOMContentLoaded",function(){k(document.documentElement.childNodes)})});c.init=function(a){var b=a;if(!a)return a;"string"===typeof a?b=a=document.querySelectorAll(a):a instanceof window.HTMLElement&&(b=[a]);k(b);return a};c.types={ANY:"act",ATTR:"a",CLASS:"c",NOATTR:"ct",NOCLASS:"at",NOTAG:"ac",TAG:"t"};c.version=a;c.defaults={attributes:void 0,events:void 0,"extends":"",id:"",prototype:{},resolvedAttribute:"resolved",template:void 0,type:c.types.ANY,unresolvedAttribute:"unresolved"};
window.skate=c;"function"===typeof define&&define(function(){return c});"object"===typeof b&&(b["default"]=c);b["default"]=c},{"./document-observer":3,"./lifecycle":5,"./registry":7,"./utils":9,"./version":10}],9:[function(a,h,b){function m(a,b){return Object.prototype.hasOwnProperty.call(a,b)}b.hasOwn=m;b.debounce=function(a){var b=!1;return function(){b||(b=!0,setTimeout(function(){b=!1;a()},1))}};b.getClosestIgnoredElement=function(a){for(;a&&a!==document;){if(a.hasAttribute(c))return a;a=a.parentNode}};
b.inherit=function(a,b,c){for(var h=Object.getOwnPropertyNames(b),l=h.length,k=0;k<l;k++){var m=h[k];if(c||void 0===a[m]){var f=Object.getOwnPropertyDescriptor(b,m);!f.get&&!f.set&&f.writable&&f.enumerable&&f.configurable?a[m]=b[m]:Object.defineProperty(a,m,f)}}return a};b.objEach=function(a,b){for(var c in a)m(a,c)&&b(a[c],c)};"use strict";var c=a("./constants").ATTR_IGNORE},{"./constants":1}],10:[function(a,h,b){b["default"]="0.13.1"},{}]},{},[8]);
