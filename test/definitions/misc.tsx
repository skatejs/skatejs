{
  customElements.define(
    "x-hello",
    class extends skate.Component<{ name: string }> {
      name: string;
      static get props() {
        return {
          name: { attribute: true }
...
}
{
  ...
  customElements.define(
    "x-counter",
    class extends skate.Component<{ count: number }> {
...
}
{
  ...
  customElements.define(
    "my-component",
    class extends skate.Component<{ myProp: any }> {
      static get props() {
        return {
          myProp: {
            coerce(value: any) {
...
}
{
  ...
  customElements.define(
    "my-component",
    class B extends skate.Component<{ myProp: any }> {
      static get props() {
        return {
          myProp: {
...
}
{
  ...
  const SkateCtor = skate.define(
    class extends skate.Component<{ who: string }> {
      static get is() {
        return "my-skate";
      }
      static get props() {
...
}
{
  ...
  customElements.define(
    "my-input",
    class extends skate.Component<{ value: any }> {
      static get props() {
        return {
  ...
  customElements.define(
    ...
    class extends skate.Component<{ value: any }> {
      ...
      render(): any {
        ...
        const explicitlySetLinkedInputPathWithCustomPropName = skate.h(
          "input",
          {
            name: "someValue",
            onChange: skate.link(this, "obj."),
            type: "text"
          }
        );
...
}
{
  ...
  customElements.define(
    "my-component",
    class extends skate.Component<{ title: string }> {
      static get props() {
        return {
...
}
{
  ...
  }
  {
    const MyElement = (props: { name: string }) =>
      skate.h("div", {}, `Hello, ${props.name}!`);

    // Renders <div>Hello, Bob!</div>
    skate.h("my-element", { name: "Bob" });
  }
  {
    const MyElement = (props: void, children: string) =>
      skate.h("div", {}, "Hello, ", children, "!");

    // Renders <div>Hello, Mary!</div>
    skate.h("my-element", {}, "Mary");
  }
  {
    const MyElement = (props: any, children: Node) =>
      <div>
        Hello, {children}!
      </div>;
...
}
{
  ...
  {
    skate.h("ul", skate.h("li", { key: "0" }), skate.h("li", { key: "1" }));
  ...
  {
    const ref = (button: HTMLButtonElement) =>
  ...
  {
    const Link: skate.SFC<{ to: string }> = ({ to }) =>
      <a href={to}>
        {skate.h("slot", {})}
      </a>;
    const LinkH: skate.SFC<{ to: string }> = ({ to }) =>
      skate.h("a", { href: to }, skate.h("slot", {}));
  }
  // slot projection attributes on Component references via JSX
  {
    type SFCSlotRef<E extends HTMLElement> = skate.SFC<{
      slot?: string;
      ref?: ((instance: E) => any);
    }>;
    ...
    class Page extends skate.Component<void> {
      ...
      render() {
        return (
          <main>
            <header>
              {skate.h("slot", { name: Page.slots.header })}
            </header>
            <nav>
              {skate.h("slot", { name: "menu" })}
            </nav>
            <section>
              {skate.h("slot", { name: Page.slots.body })}
            </section>
            <footer>
              {skate.h("slot", { name: "footer" })}
            </footer>
          </main>
        );
      }
