...
import skate, { fragment } from '../../../src/index';
...
describe('api/fragment', function () {
  ...
  describe('node', function () {
    ...
    it('should work with document fragments', function () {
      ...
      expect(fragment(frag).childNodes[0]).to.equal(elem);
    });
