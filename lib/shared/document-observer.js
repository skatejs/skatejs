(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    ...
    factory(module, exports, require('../util/get-closest-ignored-element'), require('./registry'), require('../util/walk-tree'), require('../fix/ie/innerhtml'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod, mod.exports, global.getClosestIgnoredElement, global.registry, global.walkTree, global.innerhtml);
    global.documentObserver = mod.exports;
  }
})(this, function (module, exports, _getClosestIgnoredElement, _registry, _walkTree) {
  'use strict';
