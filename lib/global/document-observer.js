(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    define(['exports', 'module', './vars', '../util/get-closest-ignored-element', './registry', '../util/walk-tree'], factory);
  } else if (typeof exports !== 'undefined' && typeof module !== 'undefined') {
    factory(exports, module, require('./vars'), require('../util/get-closest-ignored-element'), require('./registry'), require('../util/walk-tree'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, mod, global.globals, global.getClosestIgnoredElement, global.registry, global.walkTree);
    global.documentObserver = mod.exports;
  }
})(this, function (exports, module, _vars, _utilGetClosestIgnoredElement, _registry, _utilWalkTree) {
  'use strict';
