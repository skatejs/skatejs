(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    define(['exports', 'module', './emit', '../util/assign-safe', '../util/dash-case', '../util/data'], factory);
  } else if (typeof exports !== 'undefined' && typeof module !== 'undefined') {
    factory(exports, module, require('./emit'), require('../util/assign-safe'), require('../util/dash-case'), require('../util/data'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, mod, global.apiEmit, global.assignSafe, global.dashCase, global.data);
    global.unknown = mod.exports;
  }
})(this, function (exports, module, _emit, _utilAssignSafe, _utilDashCase, _utilData) {
  'use strict';
  ...
  function property(elem, name, prop) {
    ...
    prop.set = function (value) {
      ...
      if (prop.emit) {
        (0, _apiEmit['default'])(elem, prop.emit, {
          bubbles: false,
          detail: {
            name: name,
            newValue: newValue,
