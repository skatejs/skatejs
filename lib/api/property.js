(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    define(['exports', 'module', './emit', '../util/dash-case', '../util/data'], factory);
  } else if (typeof exports !== 'undefined' && typeof module !== 'undefined') {
    factory(exports, module, require('./emit'), require('../util/dash-case'), require('../util/data'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, mod, global.apiEmit, global.dashCase, global.data);
    global.unknown = mod.exports;
  }
})(this, function (exports, module, _emit, _utilDashCase, _utilData) {
  'use strict';
  ...
  function notify(elem, notify, name) {
    ...
    (0, _apiEmit['default'])(elem, notify, {
      bubbles: true,
      cancelable: false,
      detail: detail
    });
