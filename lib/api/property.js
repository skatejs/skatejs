(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    define(['exports', 'module', '../api/notify', '../util/dash-case', '../util/data'], factory);
  } else if (typeof exports !== 'undefined' && typeof module !== 'undefined') {
    factory(exports, module, require('../api/notify'), require('../util/dash-case'), require('../util/data'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, mod, global.apiNotify, global.dashCase, global.data);
    global.unknown = mod.exports;
  }
})(this, function (exports, module, _apiNotify, _utilDashCase, _utilData) {
  'use strict';
