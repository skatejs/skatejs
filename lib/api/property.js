(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    define(['exports', 'module', '../util/assign-safe', '../util/dash-case', '../util/data', './emit'], factory);
  } else if (typeof exports !== 'undefined' && typeof module !== 'undefined') {
    factory(exports, module, require('../util/assign-safe'), require('../util/dash-case'), require('../util/data'), require('./emit'));
  } else {
    var mod = {
      exports: {}
    };
...
})(this, function (exports, module, _utilAssignSafe, _utilDashCase, _utilData, _emit) {
  'use strict';
