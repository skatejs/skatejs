(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    ...
    factory(mod.exports, global.create, global.emit, global.fragment, global.init, global.index, global.ready, global.render, global.version, global.objectAssign, global.attached, global.attribute, global.created, global.defaults, global.detached, global.documentObserver, global.registry, global.customElements, global.element, global.getAllPropertyDescriptors, global.getOwnPropertyDescriptors, global.debounce, global.defineProperties, global.walkTree, global.validCustomElement);
    global.index = mod.exports;
  }
})(this, function (exports, _create, _emit, _fragment, _init, _index, _ready, _render, _version, _objectAssign, _attached, _attribute, _created, _defaults, _detached, _documentObserver, _registry, _customElements, _element, _getAllPropertyDescriptors, _getOwnPropertyDescriptors, _debounce, _defineProperties, _walkTree, _validCustomElement) {
  'use strict';
  ...
  var _validCustomElement2 = _interopRequireDefault(_validCustomElement);
  ...
  function makeCtor(name, opts) {
    ...
    fixedProp(func, 'isNative', func.type === _element2.default && (0, _customElements2.default)() && (0, _validCustomElement2.default)(name));
