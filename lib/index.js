(function (global, factory) {
  ...
  function skate(id, userOptions) {
    ...
    options.prototype.attributeChangedCallback = (0, _attribute['default'])(options.attributes);
