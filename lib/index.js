(function (factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "module", "./constants", "./utils/assign", "./lifecycle/attached", "./lifecycle/attribute", "./lifecycle/created", "./utils/dash-case", "./utils/debounce", "./lifecycle/detached", "./polyfill/document-observer", "./polyfill/element-constructor", "./polyfill/registry", "./api/defaults", "./api/init", "./api/no-conflict", "./api/type", "./api/version", "./support/custom-elements", "./utils/walk-tree", "./support/valid-custom-element"], factory);
  } else if (typeof exports !== "undefined" && typeof module !== "undefined") {
    factory(exports, module, require("./constants"), require("./utils/assign"), require("./lifecycle/attached"), require("./lifecycle/attribute"), require("./lifecycle/created"), require("./utils/dash-case"), require("./utils/debounce"), require("./lifecycle/detached"), require("./polyfill/document-observer"), require("./polyfill/element-constructor"), require("./polyfill/registry"), require("./api/defaults"), require("./api/init"), require("./api/no-conflict"), require("./api/type"), require("./api/version"), require("./support/custom-elements"), require("./utils/walk-tree"), require("./support/valid-custom-element"));
  }
})(function (exports, module, _constants, _utilsAssign, _lifecycleAttached, _lifecycleAttribute, _lifecycleCreated, _utilsDashCase, _utilsDebounce, _lifecycleDetached, _polyfillDocumentObserver, _polyfillElementConstructor, _polyfillRegistry, _apiDefaults, _apiInit, _apiNoConflict, _apiType, _apiVersion, _supportCustomElements, _utilsWalkTree, _supportValidCustomElement) {
  "use strict";
  ...
  var skateDefaults = _interopRequire(_apiDefaults);

  var skateInit = _interopRequire(_apiInit);

  var skateNoConflict = _interopRequire(_apiNoConflict);

  var skateType = _interopRequire(_apiType);

  var skateVersion = _interopRequire(_apiVersion);
