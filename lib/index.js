(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    define(['exports', 'module', './constants', './api/chain', './api/create', './api/emit', './api/event', './api/init', './api/no-conflict', './api/property', './api/ready', './api/type', './api/version', './api/watch', './util/assign', './util/assign-safe', './lifecycle/attached', './lifecycle/attributes', './lifecycle/created', './util/debounce', './defaults', './lifecycle/detached', './polyfill/document-observer', './polyfill/element-constructor', './polyfill/registry', './support/custom-elements', './util/walk-tree', './support/valid-custom-element'], factory);
  } else if (typeof exports !== 'undefined' && typeof module !== 'undefined') {
    factory(exports, module, require('./constants'), require('./api/chain'), require('./api/create'), require('./api/emit'), require('./api/event'), require('./api/init'), require('./api/no-conflict'), require('./api/property'), require('./api/ready'), require('./api/type'), require('./api/version'), require('./api/watch'), require('./util/assign'), require('./util/assign-safe'), require('./lifecycle/attached'), require('./lifecycle/attributes'), require('./lifecycle/created'), require('./util/debounce'), require('./defaults'), require('./lifecycle/detached'), require('./polyfill/document-observer'), require('./polyfill/element-constructor'), require('./polyfill/registry'), require('./support/custom-elements'), require('./util/walk-tree'), require('./support/valid-custom-element'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, mod, global.constants, global.apiChain, global.apiCreate, global.apiEmit, global.apiEvent, global.apiInit, global.apiNoConflict, global.apiProperty, global.apiReady, global.apiType, global.apiVersion, global.apiWatch, global.assign, global.assignSafe, global.attached, global.attribute, global.created, global.debounce, global.defaults, global.detached, global.documentObserver, global.elementConstructor, global.registry, global.supportsCustomElements, global.walkTree, global.validCustomElement);
    global.unknown = mod.exports;
  }
})(this, function (exports, module, _constants, _apiChain, _apiCreate, _apiEmit, _apiEvent, _apiInit, _apiNoConflict, _apiProperty, _apiReady, _apiType, _apiVersion, _apiWatch, _utilAssign, _utilAssignSafe, _lifecycleAttached, _lifecycleAttributes, _lifecycleCreated, _utilDebounce, _defaults, _lifecycleDetached, _polyfillDocumentObserver, _polyfillElementConstructor, _polyfillRegistry, _supportCustomElements, _utilWalkTree, _supportValidCustomElement) {
  'use strict';
