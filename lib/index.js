(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    define(['exports', 'module', './constants', './api/chain', './api/create', './api/emit', './api/event', './api/init', './api/no-conflict', './api/property', './api/ready', './api/type', './api/version', './api/watch', './util/assign', './util/assign-safe', './lifecycle/attached', './lifecycle/attribute', './lifecycle/created', './util/debounce', './defaults', './lifecycle/detached', './polyfill/document-observer', './polyfill/element-constructor', './polyfill/registry', './support/custom-elements', './util/walk-tree', './support/valid-custom-element'], factory);
  } else if (typeof exports !== 'undefined' && typeof module !== 'undefined') {
    factory(exports, module, require('./constants'), require('./api/chain'), require('./api/create'), require('./api/emit'), require('./api/event'), require('./api/init'), require('./api/no-conflict'), require('./api/property'), require('./api/ready'), require('./api/type'), require('./api/version'), require('./api/watch'), require('./util/assign'), require('./util/assign-safe'), require('./lifecycle/attached'), require('./lifecycle/attribute'), require('./lifecycle/created'), require('./util/debounce'), require('./defaults'), require('./lifecycle/detached'), require('./polyfill/document-observer'), require('./polyfill/element-constructor'), require('./polyfill/registry'), require('./support/custom-elements'), require('./util/walk-tree'), require('./support/valid-custom-element'));
  } else {
    var mod = {
      exports: {}
    };
