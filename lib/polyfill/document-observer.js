(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    define(['exports', 'module', '../lifecycle/attached', '../lifecycle/created', '../lifecycle/detached', '../globals', '../util/ignored', './mutation-observer', './registry', '../util/walk-tree'], factory);
  } else if (typeof exports !== 'undefined' && typeof module !== 'undefined') {
    factory(exports, module, require('../lifecycle/attached'), require('../lifecycle/created'), require('../lifecycle/detached'), require('../globals'), require('../util/ignored'), require('./mutation-observer'), require('./registry'), require('../util/walk-tree'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, mod, global.attached, global.created, global.detached, global.globals, global.ignored, global.MutationObserver, global.registry, global.walkTree);
    global.unknown = mod.exports;
  }
})(this, function (exports, module, _lifecycleAttached, _lifecycleCreated, _lifecycleDetached, _globals, _utilIgnored, _mutationObserver, _registry, _utilWalkTree) {
  'use strict';
