(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    define(['exports', 'module', 'object-assign', '../util/data', '../util/empty'], factory);
  } else if (typeof exports !== 'undefined' && typeof module !== 'undefined') {
    factory(exports, module, require('object-assign'), require('../util/data'), require('../util/empty'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, mod, global.assign, global.data, global.empty);
    global.propertiesInit = mod.exports;
  }
})(this, function (exports, module, _objectAssign, _utilData, _utilEmpty) {
  'use strict';
  ...
  function createNativePropertyDefinition(name, opts) {
    ...
    prop.init = function () {
      ...
      var initialValue = (0, _empty['default'])(internalValue) ? this[name] : internalValue;
