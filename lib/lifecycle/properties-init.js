(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', 'object-assign', '../util/dash-case', '../util/data', '../util/empty'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('object-assign'), require('../util/dash-case'), require('../util/data'), require('../util/empty'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.objectAssign, global.dashCase, global.data, global.empty);
    global.propertiesInit = mod.exports;
  }
})(this, function (exports, _objectAssign, _dashCase, _data, _empty) {
  'use strict';
