(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    ...
    factory(module, exports, require('object-assign'), require('../util/dash-case'), require('../util/data'), require('../util/empty'));
  } else {
    var mod = {
      exports: {}
    };
...
})(this, function (module, exports, _objectAssign, _dashCase, _data, _empty) {
  'use strict';
