(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    define(['exports', 'module', '../api/chain', '../util/data', '../util/protos'], factory);
  } else if (typeof exports !== 'undefined' && typeof module !== 'undefined') {
    factory(exports, module, require('../api/chain'), require('../util/data'), require('../util/protos'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, mod, global.apiChain, global.data, global.protos);
    global.unknown = mod.exports;
  }
})(this, function (exports, module, _apiChain, _utilData, _utilProtos) {
  'use strict';
