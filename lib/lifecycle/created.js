(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    define(['exports', 'module', '../api/property', './created-on-descendants', '../util/data', './events', './patch-attribute-methods', './properties-created', './properties-ready', './prototype', './renderer', './resolve'], factory);
  } else if (typeof exports !== 'undefined' && typeof module !== 'undefined') {
    factory(exports, module, require('../api/property'), require('./created-on-descendants'), require('../util/data'), require('./events'), require('./patch-attribute-methods'), require('./properties-created'), require('./properties-ready'), require('./prototype'), require('./renderer'), require('./resolve'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, mod, global.apiProperty, global.createdOnDescendants, global.data, global.events, global.patchAttributeMethods, global.propertiesCreated, global.propertiesReady, global.prototype, global.renderer, global.resolve);
    global.created = mod.exports;
  }
})(this, function (exports, module, _apiProperty, _createdOnDescendants, _utilData, _events, _patchAttributeMethods, _propertiesCreated, _propertiesReady, _prototype, _renderer, _resolve) {
  'use strict';
