(function (global, factory) {
  if (typeof define === 'function' && define.amd) {
    define(['exports', 'module', '../util/data', '../api/emit', './events', './patch-attribute-methods', './property', './properties-created', './properties-ready', './prototype', './renderer', './resolve'], factory);
  } else if (typeof exports !== 'undefined' && typeof module !== 'undefined') {
    factory(exports, module, require('../util/data'), require('../api/emit'), require('./events'), require('./patch-attribute-methods'), require('./property'), require('./properties-created'), require('./properties-ready'), require('./prototype'), require('./renderer'), require('./resolve'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, mod, global.data, global.emit, global.events, global.patchAttributeMethods, global.property, global.propertiesCreated, global.propertiesReady, global.prototype, global.renderer, global.resolve);
    global.created = mod.exports;
  }
})(this, function (exports, module, _utilData, _apiEmit, _events, _patchAttributeMethods, _property, _propertiesCreated, _propertiesReady, _prototype, _renderer, _resolve) {
  'use strict';
  ...
  function notifyReady(elem) {
    (0, _emit['default'])(elem, 'skate.ready', {
      bubbles: false,
      cancelable: false
    });
  }
