(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', './get-own-property-descriptors', './protos'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('./get-own-property-descriptors'), require('./protos'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.getOwnPropertyDescriptors, global.protos);
    global.getAllPropertyDescriptors = mod.exports;
  }
})(this, function (exports, _getOwnPropertyDescriptors, _protos) {
  'use strict';
