...
function getPropNamespace(name) {
  return `api/property/${typeof name === 'symbol' ? String(name) : name}`;
}
...
function createNativePropertyDefinition(name, opts) {
  ...
  prop.created = function (elem) { // eslint-disable-line func-names
    const propData = data(elem, getPropNamespace(name));
  ...
  prop.get = function () { // eslint-disable-line func-names
    const propData = data(this, getPropNamespace(name));
