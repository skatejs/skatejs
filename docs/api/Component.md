...
- [`shouldRenderCallback()`](#shouldRenderCallback)
...
The `Component` mixin is what is used to create the base `Component` class. This allows you to specify a custom base class, if need be. This is an extension of the `Render` mixins to render your component using [Incremental DOM]().
