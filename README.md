...
***The Sauce tests above may show the iPhone failing. This in fact does pass in the simulator and when run on Sauce from the CLI. It doesn't pass when run from TravisCI for some reason. We're investigating why now, but rest assured that it does pass.***
