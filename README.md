...
- [Resources](#resources)
- [Questions?](#questions)
- [`skate(componentName, componentDefinition)` API](#skatecomponentname-componentdefinition-api)
  - [`prototype`](#prototype)
  - [`events`](#events)
  - [`created`](#created)
...
- [Custom bindings](#custom-bindings)
  - [Considerations](#considerations)
    - [1. You're deviating from the spec.](#1-youre-deviating-from-the-spec)
